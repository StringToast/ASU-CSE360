...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		//Label to display username error message
		setupLabelUI(label_UsernameError, "Arial", 14, width, Pos.CENTER, 0, 185);
		// Establish the text input operand field for the password
		setupTextUI(text_AdminPassword1, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 240, 
				true);
		...
		// Establish the text input operand field for the password
		setupTextUI(text_AdminPassword2, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 290, 
				true);
		...
		setupButtonUI(button_AdminSetup, "Dialog", 18, 200, Pos.CENTER, 475, 240);
