...
public class ViewNewAccount {
	...
	*/
	...
	private ViewNewAccount() {
		...
		// Label to display the username error message
		setupLabelUI(label_Username_Error, "Arial", 14, width, Pos.CENTER, 0 , 185);
		
		// Establish the text input operand field for the password
		setupTextUI(text_Password1, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 240, true);
        ...
        setupButtonUI(button_UserSetup, "Dialog", 18, 200, Pos.CENTER, 475, 240);
