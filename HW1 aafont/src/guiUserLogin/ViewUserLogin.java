...
public class ViewUserLogin {
	...
	protected static Label label_LengthError = new Label();
	...
	private ViewUserLogin() {
		...
		//Label for length being too long, defense against malicious attacks
		setupLabelUI(label_LengthError, "Arial", 14, width, Pos.CENTER, 0, 250);
		...
		theRootPane.getChildren().addAll(
				...
				label_LogInInsrtuctions, label_AccountSetupInsrtuctions, text_Username, label_LengthError,
